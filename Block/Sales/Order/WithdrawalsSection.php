...
class WithdrawalsSection extends Template
{
    ...
    public function getCardState(): ?string
    {
        ...
        return match ($e->ineligibleReason) {
            ...
            \MageMe\EUWithdrawal\Model\Frontend\Dto\PerOrderEligibility::REASON_OUT_OF_REGION,
            \MageMe\EUWithdrawal\Model\Frontend\Dto\PerOrderEligibility::REASON_OUT_OF_GROUP => null,
            default => null,
        };
    }
